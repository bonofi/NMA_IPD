...
# CONCEPTUALLY, IT IS NOT EASY TO CONTROL THE "TRUE" SUBGROUP EFFECT USING A STATISTICAL INTERACTION FOR THE DATA GENERATING MODEL, BECAUSE THERE IS NO INTUITIVE TRANSLATION OF THE MODEL PARAMETERS (interaction term and direct effects) INTO "TRUE" AVERAGE AND SUBGROUP EFFECTS.
